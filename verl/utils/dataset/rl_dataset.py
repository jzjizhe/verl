...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.tokenizer_golden_answer and row_dict['extra_info']['split']=='train':
            ...
            # 4. 存入 row_dict
            row_dict["golden_answer_ids"] = golden_answer_input_ids[0]
            row_dict["golden_answer_attention_mask"] = golden_answer_attention_mask[0]
            row_dict["golden_answer_position_ids"] = golden_answer_position_ids[0]
