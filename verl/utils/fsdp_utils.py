...
def get_fsdp_wrap_policy(module, config=None, is_lora=False,custom_wrap_classes=None):
    ...
    if custom_wrap_classes:
        
        def custom_wrap_fn(module):
            return any(isinstance(module, cls) for cls in custom_wrap_classes)
        
        custom_policy = functools.partial(
            lambda_auto_wrap_policy, 
            lambda_fn=custom_wrap_fn
        )
