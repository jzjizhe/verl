#!/bin/bash
set -x
export PATH=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtsearch-assistant/ai-search/zhangchenheng/archive/system/conda_envs/reprl/bin:/usr/local/cuda/bin:/opt/rh/devtoolset-9/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/conda/bin:/workdir//jdk-11.0.12//bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin:/usr/local/cuda/bin:/opt/rh/devtoolset-9/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/conda/bin:/opt/meituan/hadoop/bin
PATH=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtsearch-assistant/ai-search/zhangchenheng/archive/system/conda_envs/reprl/bin:/usr/local/cuda/bin:/opt/rh/devtoolset-9/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/conda/bin:/workdir//jdk-11.0.12//bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin:/usr/local/cuda/bin:/opt/rh/devtoolset-9/root/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/conda/bin:/opt/meituan/hadoop/bin
